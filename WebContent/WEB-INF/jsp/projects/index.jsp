	...
	<div id="content" class="cont-left">
		...
		<div class="blog-post">
			...
			<div class="post-content">
				...
				<div class="post-metadata">
					<p>Project website: <a href="http://www.groupwareworkbench.org.br/" target="_blank">http://www.groupwareworkbench.org.br/</a></p>
					<h5>On media:</h5>
					<ul class="gallery-thumbs-caption">
						<li class="one-fourth">
							<div>                                                                         
								<a class="link" href="<c:url value="/on-media/AUN-06-2009.pdf"/>" title="AUN (Agência Universitária de Notícias). Online: http://www.usp.br/aun/exibir.php?id=2846" >
									<img class="box-img" src="<c:url value="/on-media/AUN-06-2009.jpg"/>" alt="AUN, June, 2009" />
								</a>
							</div>
		...
		<div class="blog-post">
			...
			<div class="post-content">
				...
				<div class="post-metadata">
					<p>Project website: <a href="http://www.arquigrafia.org.br" target="_blank">www.arquigrafia.org.br</a></p>
					<h5>On media:</h5>
					<ul class="gallery-thumbs-caption">
						<li class="one-fifth">
							<div>   
								<a class="link" href="<c:url value="/on-media/Pesquisa_195-25.pdf"/>" title="FAPESP Magazine. Online: http://revistapesquisa.fapesp.br/2012/05/11/as-cidades-em-imagens/" >
									<img class="box-img" src="<c:url value="/on-media/capaRevistaFAPESP.jpg"/>" alt="FAPESP Magazine n. 195, May, 2012" />
								</a>
							</div>
							<div class="img-caption">
						...
						<li class="one-fifth">
							<div>   
								<a class="link" href="<c:url value="/on-media/PortalAprendizUOL.pdf"/>" title="Portal Aprendiz UOL. Online: http://portal.aprendiz.uol.com.br/2012/04/12/usp-lanca-plataforma-colaborativa-sobre-arquitetura-brasileira/" >
									<img class="box-img" src="<c:url value="/on-media/PortalAprendizPeq.jpg"/>" alt="Portal Aprendiz UOL, April, 2012." height="160"/>
								</a>
							</div>
							<div class="img-caption">
						...
						<li class="one-fifth last">
							<div>   
								<a class="link" href="<c:url value="/on-media/cienciahoje-05-2012.pdf"/>" title="Ciência Hoje. Online: http://cienciahoje.uol.com.br/blogues/bussola/2012/05/novo-olhar-sobre-a-arquitetura-urbana/" >
									<img class="box-img" src="<c:url value="/on-media/cienciahoje-05-2012.jpg"/>" alt="Ciência Hoje, May, 2012." height="160"/>
								</a>
							</div>
							<div class="img-caption">
								<h4>Ciência Hoje</h4>                   
		...
		<div class="blog-post">
			...
			<div class="post-content">
				...
				<div class="post-metadata">
					<p>Project website: <a href="http://www.choreos.eu" target="_blank">http://www.choreos.eu</a></p>
					...
					<ul class="gallery-thumbs-caption">
						<li class="one-fourth">
							<div> 
								<a class="link" href="<c:url value="/on-media/AUN-06-2011.pdf"/>" title="AUN (Agência Universitária de Notícias). Online: http://www.usp.br/aun/exibir.php?id=3962" >
									<img class="box-img" src="<c:url value="/on-media/AUN-06-2011.jpg"/>" alt="AUN, June, 2011" />
								</a>
							</div>
